            ...
            <table width="350" border="0" cellpadding="0" cellspacing="0">
                ...
                <tr>
                    ...
                    <td align="right">
                        ...
                        <a>
                        	<b></b>
                        	<font color="red">欢迎您，<s:property value="#session.SYS_USER.name"/> &nbsp;</font>
                        </a>
                    </td>
        ...
        <div class="left_grzx1">
            ...
            <table width="98%" border="0" align="center">
	            	<tr>
		                  ...
		                  <td width="180px"><strong>信息分类</strong></td>
		                  <td width="180px"><strong>创建人</strong></td>
		                  <td width="180px"><strong>创建时间</strong></td>
		            </tr>
	                ...
	                <tr>
	                    <td height="23">
	                    	<!-- 地址 -->
		                  	...
		                  	<!-- 超链接,infoViewUrl:对应上面的var="infoViewUrl" -->
	                    ...
	                    <td width="150px"><s:date name="createTime" format="yyyy-MM-dd HH:mm:ss"/></td>
	                </tr>
                </s:iterator>
            </table>
        </div>
        ...
        <div class="lc_grzx1">
            ...
            <table width="98%" border="0" align="center">
            	  <tr>
	                  ...
	                  <td width="180px"><strong>受理状态</strong></td>
	                  <td width="180px"><strong>是否匿名投诉</strong></td>
	                  <td width="180px"><strong>投诉时间</strong></td>
	              </tr>
	                ...
	                <tr>
	                    <td height="23">
	                    	<!-- 地址 -->
		                  	...
		                  	<!-- 超链接,infoViewUrl:对应上面的var="complainViewUrl" -->
	                    ...
	                    <td width="180px"><s:date name="compTime" format="yyyy-MM-dd HH:mm:ss"/></td>
	                </tr>
                </s:iterator>
            </table>
        </div>
